...
allocated is below 1GB for up to 1 million of participants. We observe an almost quadratic increase of the memory allocation in the number of participants. Although clearly there is room for improvement in the memory consumption scalability, we have to note that in our implementation, we have not yet performed any memory optimization techniques, like using specialized data structures that offer compression, but we have used the most common out-of-the-box container data structures offered by the Haskell language, in particular the Map \footnote{\href{url}{http://hackage.haskell.org/package/containers-0.6.2.1/docs/Data-Map-Strict.html}} data structure.
