...
Let $t'$ be the smallest time slot in which $B_{j+k}$ appears in $\check \state_2^{P_i}[t']$
 %\nnote{Maybe you mean $\check \state_1^{P_i}[t']$ because that is what we have said above: "the parties need to %wait that the $(j+k)$-th block of $\state_1$ is part of $\check \state_1^{P_i}[t]$" } 
