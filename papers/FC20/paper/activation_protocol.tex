...
\begin{myenumerate}
	...
	\item Run $\ledger_1$ and when the $(j+k)$-th block $B^i_{j+k}$ becomes part of $\check \state_1^{P_i}[t]$ \nnote{$\check \state_1^{P_i}[t]$} for some $t\geq t^\upd$
