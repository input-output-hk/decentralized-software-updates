...
If $\ledger_2$ supports temporary dishonest majority~\cite{DBLP:journals/corr/abs-1908-00427} then we do not need the assumption on the equality of the parameters to 
hold anymore.
...
For the best of our knowledge, the positive results regarding temporary dishonest majority are for PoW blockchain like Bitcoin (see~\cite{DBLP:journals/corr/abs-1908-00427}
for a formal treatment of the problem).
