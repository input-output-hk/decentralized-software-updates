...
corresponds to the moment in which the $j$-th block appears in $\ledger_1^{P_i}$.\footnote{We recall that the $j$-th block is used as a synchronization flag by the parties
