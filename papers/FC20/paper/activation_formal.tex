...
The parameter $\Delta_1$ defines how much time has to pass until the number of honest parties that have received $(\activate,\cdot)$
...
The above implies that $\state_2$ \nnote{$\ledger_2$} extends $\state_1$ \nnote{$\ledger_1$} and that $\ledger_2$ is secure (i.e. it enjoys consistency and liveness).
