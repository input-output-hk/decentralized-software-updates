...
We introduce a \emph{vote} as a new transaction type that can only be included in a block during the voting period. The core information conveyed by the vote transaction is summarized in the following tuple:
\begin{align*}
( H(<SIP/UP>), \\
  SU_{Flag}, \\
  <confidence>, \\
...
\subsubsection{On Thresholds and Assumptions}
 p
\nnote{
- 3-valued vote YES/NO/ABSTAIN.
