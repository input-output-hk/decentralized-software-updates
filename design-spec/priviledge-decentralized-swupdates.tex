...
\item[Approval] In this phase, the information about the implementation of an
  ...
  is referred to as UP. As in the ideation phase, the stakeholders vote on the
  implementation.
...
One the SIP is revealed, stakeholders can access all the its details and a
...
activation phase.
%
When this kind of updates are approved, the update system simply records this event,
...
protocol version will be activated. To this end, we require that the \emph{last
  endorsement} required for meeting the adoption threshold \emph{is stable} $k$
